...
export default function AddPresentationComponent() {
    ...
    const AddPresentation = async () => {
        try {
            const response = await axios.post('http://localhost:8080/addPresentation', {
                company : company,
                address : address,
                date : date,
                attending : attending,
    ...
    return (
        <div>
            <Button variant="outlined" color="primary" onClick={handleClickOpen}>Add presentation</Button>
